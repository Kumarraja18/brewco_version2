      ...
      <section className="info">
        <div className="info-content">
          ...
          <div className="steps-wrapper">
            <ol className="steps">
              <li><strong>Create Account:</strong> Register and complete your profile</li>
              <li><strong>Browse Locations:</strong> Explore our brew & co locations</li>
              <li><strong>Reserve Seat:</strong> Pick your favorite spot and time</li>
            </ol>
            <ol className="steps" style={{ counterReset: 'step 3' }}>
              <li><strong>Order Ahead:</strong> Choose from our signature menu</li>
              <li><strong>Pay Online:</strong> Quick and secure payment</li>
              <li><strong>Relax & Enjoy:</strong> Track your order and savor the moment</li>
            </ol>
          </div>
        </div>
      </section>
